        ...
        <div class='flex-1 min-w-0'>
          <a class='focus:outline-none' href='#'>
            ...
            <p class='text-sm text-gray-500 line-clamp-3'>
              Trouves le service qui te convient dolor sit amet, consectetur adipisicing elit. Amet deserunt dicta, dolorem eius fuga iure maxime molestiae, molestias neque numquam
